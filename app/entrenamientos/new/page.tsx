...
export default async function NewWorkoutPage({
  ...
  const baseId =
    typeof resolvedParams.baseId === "string" ? resolvedParams.baseId : null;
  const dateParam =
  ...
  // If a `date` query param was provided (YYYY-MM-DD), use it as the initial date
  if (dateParam) {
    const normalized = (() => {
    ...
    if (normalized) initialFecha = normalized;
  }
