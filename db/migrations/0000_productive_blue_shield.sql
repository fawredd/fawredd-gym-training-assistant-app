...
ALTER TABLE "fawredd_gym"."workouts" ADD CONSTRAINT "workouts_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "fawredd_gym"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fawredd_gym"."ai_logs" ADD CONSTRAINT "ai_logs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "fawredd_gym"."users"("id") ON DELETE no action ON UPDATE no action;
*/